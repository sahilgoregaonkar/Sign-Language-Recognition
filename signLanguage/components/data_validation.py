...
class DataValidation:
    ...
    def validate_all_files_exist(self) -> bool:
        try:
            ...
            all_files = os.listdir(self.data_ingestion_artifact.feature_store_path + "\sign language project.v1i.yolov5pytorch")
            logging.info(f"{self.data_ingestion_artifact.feature_store_path}")
            logging.info(f"{all_files}")

            for file in all_files:
                
                logging.info(f"{file} /// {self.data_validation_config.required_file_list} ")
